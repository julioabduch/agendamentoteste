  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50">
    <div class="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 border border-gray-100 text-center">
      <ClientOnly>
        ...
        <template #fallback>
          <div class="space-y-4">
            <div class="animate-spin h-8 w-8 border-4 border-gray-300 border-t-transparent rounded-full mx-auto"></div>
            <h2 class="text-2xl font-bold text-gray-800">Carregando...</h2>
            <p class="text-gray-600">Preparando autenticação...</p>
          </div>
        </template>
      </ClientOnly>
    </div>
